...
public class GermplasmNewRequest {
     ...
     * different levels of detail: either by using the general codes such as
     * 100, 200, 300, 400, or by using the more specific codes such as 110, 120,
     * etc. 100) Wild 110) Natural 120) Semi-natural/wild 130) Semi-natural/sown
     * 200) Weedy 300) Traditional cultivar/landrace 400) Breeding/research
     * material 410) Breeders line 411) Synthetic population 412) Hybrid 413)
     * Founder stock/base population 414) Inbred line (parent of hybrid
     * cultivar) 415) Segregating population 416) Clonal selection 420) Genetic
     * stock 421) Mutant (e.g. induced/insertion mutants, tilling populations)
     * 422) Cytogenetic stocks (e.g. chromosome addition/substitution,
     * aneuploids, amphiploids) 423) Other genetic stocks (e.g. mapping
     * populations) 500) Advanced or improved cultivar (conventional breeding
     * methods) 600) GMO (by genetic engineering) 999) Other (Elaborate in
     * REMARKS field)
     */
     ...
     * assigned when a sample is entered into the genebank collection MCPD
     * (v2.1) (ACCENUMB) 2. This is the unique identifier for accessions within
     * a genebank, and is assigned when a sample is entered into the genebank
     * collection (e.g. \"PI 113869\").
     *
   ...
   *
    ...
    public GermplasmNewRequest acquisitionDate(String acquisitionDate) {
        this.acquisitionDate = acquisitionDate;
        return this;
    }

    /**
     * The date this germplasm was acquired by the genebank MCPD (v2.1)
     * (ACQDATE) 12. Date on which the accession entered the collection
     * [YYYYMMDD] where YYYY is the year, MM is the month and DD is the day.
     * Missing data (MM or DD) should be indicated with hyphens or \"00\"
     * [double zero].
     *
   ...
   *
    ...
    /**
     * The unique identifier for the breeding method used to create this
     * germplasm
     *
   ...
   *
    ...
    /**
     * Common name for the crop MCPD (v2.1) (CROPNAME) 10. Common name of the
     * crop. Example: \"malting barley\", \"mas\".
     *
   ...
   *
    ...
    /**
     * 3-letter ISO 3166-1 code of the country in which the sample was
     * originally collected MCPD (v2.1) (ORIGCTY) 13. 3-letter ISO 3166-1 code
     * of the country in which the sample was originally collected (e.g.
     * landrace, crop wild relative, farmers variety), bred or selected
     * (breeding lines, GMOs, segregating populations, hybrids, modern
     * cultivars, etc.). Note- Descriptors 14 to 16 below should be completed
     * accordingly only if it was \"collected\".
     *
   ...
   *
    ...
    /**
     * Genus name for taxon. Initial uppercase letter required. MCPD (v2.1)
     * (GENUS) 5. Genus name for taxon. Initial uppercase letter required.
     * MIAPPE V1.1 (DM-43) Genus - Genus name for the organism under study,
     * according to standard scientific nomenclature.
     *
     * @return genus
   *
     */
    ...
    /**
     * Name of the germplasm. It can be the preferred name and does not have to
     * be unique. MCPD (v2.1) (ACCENAME) 11. Either a registered or other
     * designation given to the material received, other than the donors
     * accession number (23) or collecting number (3). First letter uppercase.
     * Multiple names are separated by a semicolon without space.
     *
   ...
   *
    ...
    /**
     * The Permanent Unique Identifier which represents a germplasm MIAPPE V1.1
     * (DM-41) Biological material ID - Code used to identify the biological
     * material in the data file. Should be unique within the Investigation. Can
     * correspond to experimental plant ID, seed lot ID, etc This material
     * identification is different from a BiosampleID which corresponds to
     * Observation Unit or Samples sections below. MCPD (v2.1) (PUID) 0. Any
     * persistent, unique identifier assigned to the accession so it can be
     ...
     * each accession. The Secretariat of the International Treaty on Plant
     * Genetic Resources for Food and Agriculture (PGRFA) is facilitating the
     * assignment of a persistent unique identifier (PUID), in the form of a
     * DOI, to PGRFA at the accession level. Genebanks not applying a true PUID
     * to their accessions should use, and request recipients to use, the
     * concatenation of INSTCODE, ACCENUMB, and GENUS as a globally unique
     * identifier similar in most respects to the PUID whenever they exchange
     * information on accessions with third parties.
     *
     * @return germplasmPUI
   *
     */
    ...
    /**
     * Description of any process or treatment applied uniformly to the
     * germplasm, prior to the study itself. Can be provided as free text or as
     * an accession number from a suitable controlled vocabulary.
     *
   ...
   *
    ...
    /**
     * The code for the institute that maintains the material. MCPD (v2.1)
   ...
   *
    ...
    /**
     * The cross name and optional selection history. MCPD (v2.1) (ANCEST) 20.
     * Information about either pedigree or other description of ancestral
     * information (e.g. parent variety in case of mutant or selection). For
     * example a pedigree 'Hanna/7*Atlas//Turk/8*Atlas' or a description
     * 'mutation found in Hanna', 'selection from Irene' or 'cross involving
     * amongst others Hanna and Irene'.
     *
     * @return pedigree
   *
     */
   ...
   *
    ...
    /**
     * Description of the material source MIAPPE V1.1 (DM-56) Material source
   ...
   *
     ...
     * MCPD (v2.1) (SPECIES) 6. Specific epithet portion of the scientific name
     * in lowercase letters. Only the following abbreviation is allowed: \"sp.\"
     * MIAPPE V1.1 (DM-44) Species - Species name (formally: specific epithet)
     * for the organism under study, according to standard scientific
     * nomenclature.
     *
     * @return species
   *
     ...
     * species name MCPD (v2.1) (SPAUTHOR) 7. Provide the authority for the
     * species name.
     *
   ...
   *
     ...
     * (v2.1) (SUBTAXA) 8. Subtaxon can be used to store any additional
     * taxonomic identifier. The following abbreviations are allowed: \"subsp.\"
     * (for subspecies); \"convar.\" (for convariety); \"var.\" (for variety);
     * \"f.\" (for form); \"Group\" (for \"cultivar group\"). MIAPPE V1.1
     * (DM-44) Infraspecific name - Name of any subtaxa level, including
     * variety, crossing name, etc. It can be used to store any additional
     * taxonomic identifier. Either free text description or key-value pair list
     * format (the key is the name of the rank and the value is the value of the
     * rank). Ranks can be among the following terms: subspecies, cultivar,
     * variety, subvariety, convariety, group, subgroup, hybrid, line, form,
     * subform. For MCPD compliance, the following abbreviations are allowed:
     * subsp. (subspecies); convar. (convariety); var. (variety); f. (form);
   ...
   *
    ...
    /**
     * List of alternative names or IDs used to reference this germplasm MCPD
     * (v2.1) (OTHERNUMB) 24. Any other identifiers known to exist in other
     * collections for this accession. Use the following format:
     * INSTCODE:ACCENUMB;INSTCODE:identifier;INSTCODE and identifier are
     * separated by a colon without space. Pairs of INSTCODE and identifier are
     * separated by a semicolon without space. When the institute is not known,
     * the identifier should be preceded by a colon.
     *
     * @return synonyms
   *
     */
     ...
     * Taxon should be always listed as \"ncbiTaxon\" preferably with a purl.
     * The rank of this ID should be species. MIAPPE V1.1 (DM-42) Organism - An
     * identifier for the organism at the species level. Use of the NCBI taxon
     * ID is recommended.
     *
     * @return taxonIds
   *
