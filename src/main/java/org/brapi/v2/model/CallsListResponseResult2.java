...
public class CallsListResponseResult2   {
  @JsonProperty("data")
  @Valid
  private List<Call2> data = new ArrayList<Call2>();
  ...
  public CallsListResponseResult2 data(List<Call2> data) {
    this.data = data;
    return this;
  }

  public CallsListResponseResult2 addDataItem(Call2 dataItem) {
  ...
  **/
  @ApiModelProperty(required = true, value = "")
      @NotNull
    @Valid
    public List<Call2> getData() {
    return data;
  }

  public void setData(List<Call2> data) {
    this.data = data;
  }

  public CallsListResponseResult2 expandHomozygotes(Boolean expandHomozygotes) {
  ...
  **/
  ...
  public CallsListResponseResult2 sepPhased(String sepPhased) {
  ...
  **/
  ...
  public CallsListResponseResult2 sepUnphased(String sepUnphased) {
  ...
  **/
  ...
  public CallsListResponseResult2 unknownString(String unknownString) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CallsListResponseResult2 callsListResponseResult = (CallsListResponseResult2) o;
